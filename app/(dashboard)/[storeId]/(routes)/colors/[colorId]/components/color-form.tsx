...
export const ColorForm:React.FC<ColorFormProps> = ({
    ...
    //PATCH (update) if initialData is present, else POST (create)
                        ...
                        <FormField
                            ...
                            render={({field}) =>(
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder="Colors name" {...field}/>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )}
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-24">
                                            <Input disabled={loading} placeholder="Colors value" {...field}/>
                                            <div className="border p-4 roundede-full" style={{backgroundColor: form.getValues().value}}>
